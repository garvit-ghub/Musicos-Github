    ...
    <div style={{ padding: '20px', maxWidth: '1000px', margin: '0 auto' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '5px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
          <img src="/Dark.png" alt="Logo" style={{ height: '40px', width: '40px', borderRadius: '8px', objectFit: 'cover', filter: 'drop-shadow(0 0px 10px rgba(16, 185, 129, 0.3))' }} />
          <h2 style={{ margin: 0 }}>Admin Dashboard</h2>
        </div>
        <button onClick={fetchStats} className="btn" style={{ background: '#3f3f46', padding: '8px 16px' }}>Refresh</button>
      </div>
      ...
      {stats ? (
        ...
        <div style={{ textAlign: 'center', margin: '50px 0', color: '#10b981' }}>Loading metrics...</div>
      )}

      <div style={{ marginTop: '40px', padding: '30px', background: '#18181b', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.05)' }}>
        <h3 style={{ marginBottom: '25px', color: '#10b981' }}>Administrative Controls</h3>
