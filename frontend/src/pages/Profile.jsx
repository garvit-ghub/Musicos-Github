...
const Profile = () => {
  ...
  const badgeStyle = { background: 'rgba(16,185,129,0.1)', color: '#10b981', padding: '6px 12px', borderRadius: '8px', fontSize: '0.9rem', fontWeight: 'bold', display: 'inline-block' };
  ...
  return (
    <div style={containerStyle}>
      ...
      <h3 style={{ color: '#10b981', marginBottom: '20px', fontSize: '1.5rem' }}>Order History</h3>
      {loading ? (
